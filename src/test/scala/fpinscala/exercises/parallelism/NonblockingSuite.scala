...
class NonblockingSuite extends PropSuite:
  ...
  private val genParParString: Gen[Par[Par[String]]] = genString
    .map(str => Par.unit(Par.unit(str)))
  ...
  test("Nonblocking.choice")(genParInt ** genParInt ** genParBoolean):
    case t ** f ** p => checkChoice(t, f, p)(Par.choice[Int](p)(t, f))

  test("Nonblocking.choiceN")(genParInt ** genListOfParString):
    case p ** ps => checkChoiceN(p, ps)(Par.choiceN[String](p)(ps))

  test("Nonblocking.choiceViaChoiceN")(genParInt ** genParInt ** genParBoolean):
    case t ** f ** p => checkChoice(t, f, p)(Par.choiceViaChoiceN[Int](p)(t, f))
  ...
  test("Nonblocking.chooser")(genParInt ** genMap):
    case p ** ps => checkFlatMap(p, ps)(Par.chooser[Int, String](p)(ps))

  test("Nonblocking.choiceViaFlatMap")(genParInt ** genParInt ** genParBoolean):
    case t ** f ** p => checkChoice(t, f, p)(Par.choiceViaFlatMap[Int](p)(f, t))

  test("Nonblocking.choiceNViaFlatMap")(genParInt ** genListOfParString):
    case p ** ps => checkChoiceN(p, ps)(Par.choiceNViaFlatMap[String](p)(ps))
  ...
  test("Nonblocking.flatMapViaJoin")(genParInt ** genMap):
    case p ** ps => checkFlatMap(p, ps)(Par.flatMapViaJoin[Int, String](p)(ps))
